...
const Contacto = () => {
    ...
    const handleOnsubmit = (event) => {
        ...
        `
        const info = {
            to:'jmf@casasylagos.cl',
            replyTo: email,
            subject:'Formulario Contacto',
            text:'Parque Los Hualles',
            html: msj,
            nombre: nombre,
            email: email,
            telefono:telefono,
                ...
                <div>
                    <div onClick={() => window.open('tel:+56923706531')} style={{display:'flex', alignItems:'center', cursor:'pointer'}}>
                        ...
                        <div style={{paddingLeft:12}}>
                            <p style={{margin:0}}>+56 9 6208 7161</p>
                        </div>
                    </div>
                    <Anchor  href="mailto:jmf@casasylagos.cl" style={{display:'flex', alignItems:'center', cursor:'pointer'}}>
                        <Email width="32" height="32" strokewidth="2"/>
                        <div style={{paddingLeft:12}}>
                            <p style={{margin:0}}>jmf@casasylagos.cl</p>
                        </div>
                    </Anchor>
                </div>
            </ProyectoContainer>
